var Fe=Object.defineProperty;var Pe=(e,s,a)=>s in e?Fe(e,s,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[s]=a;var ne=(e,s,a)=>Pe(e,typeof s!="symbol"?s+"":s,a);import{r as n,j as t}from"./vendor-Dso59N_O.js";import{u as ce,C as $e,O as Ie,E as Ue,f as ze,g as ie,H as Ge,N as re,b as de,h as ue,a as fe,i as Be,d as We,c as me,j as He,e as qe}from"./react-three-DP099Jq1.js";import{aq as oe,ap as H,aU as pe,V as Y,bb as he,aF as be,d as xe,af as Ke,M as Ve,aJ as Qe,aT as Ye,ai as Je,bc as Xe,at as we,aG as Ze,am as et}from"./three-CQO4KQ3J.js";import{u as tt,A as st,l as at}from"./AdminThreeDModelManager-BZ4Fm6bk.js";import"./postprocessing-C5EpOQZm.js";import"./index-u9UjzlK0.js";import"./supabase-BNwldGNI.js";import"./motion-C5B2NUSC.js";const nt="/models/watch-v1.glb",it="/studio.hdr",ge=1.8,ye=[0,0,8],J="#EEEAE1",rt=700,ot=940,lt=720*1e3,ct=[{id:"pbr",label:"PBR"},{id:"arctic",label:"ARCTIC"},{id:"pen",label:"PEN"}],dt={pbr:"#ffffff",arctic:"#ffffff",pen:"#ffffff"},R={id:"local-watch-fallback",name:"Tag Heuer Monaco x Gulf",description:"Built-in local watch model",file_name:"watch-v1.glb",storage_path:"models/watch-v1.glb",source_file_name:null,source_storage_path:null,source_format:null,hdri_file_name:null,hdri_storage_path:null,is_published:!0,is_featured:!0,is_watch:!1,sort_order:0,plaster_color:J,created_at:"",updated_at:"",public_url:nt,hdri_public_url:null};let k=null,L=null;async function ve(e=!1){const s=Date.now();if(e)k=null,L=null;else{if(k&&k.expiresAt>s)return k.models;if(L)return L}const a=at().then(i=>(k={expiresAt:Date.now()+lt,models:i},i));L=a;try{return await a}finally{L===a&&(L=null)}}function Me(e){return e.length>0?e:[R]}const ut=`
.watch-studio {
  opacity: 0;
  filter: blur(24px);
  transition:
