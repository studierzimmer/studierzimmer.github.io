var ut=Object.defineProperty;var pt=(t,n,s)=>n in t?ut(t,n,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[n]=s;var Me=(t,n,s)=>pt(t,typeof n!="symbol"?n+"":n,s);import{r as i,j as a}from"./vendor-FJugjbCd.js";import{u as Ne,C as ft,O as mt,E as ht,f as gt,g as Ee,H as wt,N as Se,d as Le,h as Ae,a as Te,i as bt,b as vt,c as ke,j as xt,e as yt}from"./react-three-Cf3ZNpbQ.js";import{aq as je,ap as ie,aU as De,V as ce,bc as Ce,aF as Ie,d as Oe,af as Mt,M as Et,aJ as St,aT as jt,ai as Rt,bd as _t,at as ze,aG as Nt,am as Lt}from"./three-O18aLqgg.js";import{A as At,l as Tt}from"./AdminThreeDModelManager-1RTGXGsF.js";import{n as kt,S as Dt}from"./index-B6_EXeUo.js";import"./postprocessing-dT4kHdQ4.js";import"./supabase-BUBRDUZV.js";import"./motion-Cje7NOoT.js";const Ct="/models/watch-v1.glb",It="/studio.hdr",Fe=1.8,Pe=[0,0,8],de="#EEEAE1",Ot=700,zt=940,Ft=720*1e3,Pt=1400,Re=44,$t=[{id:"pbr",label:"RENDER"},{id:"arctic",label:"ARCTIC"},{id:"pen",label:"PEN"}],Ut={pbr:"#ffffff",arctic:"#ffffff",pen:"#ffffff"},O={id:"local-watch-fallback",name:"Tag Heuer Monaco x Gulf",description:"Built-in local watch model",file_name:"watch-v1.glb",storage_path:"models/watch-v1.glb",source_file_name:null,source_storage_path:null,source_format:null,hdri_file_name:null,hdri_storage_path:null,is_published:!0,is_featured:!0,is_watch:!1,sort_order:0,plaster_color:de,created_at:"",updated_at:"",public_url:Ct,hdri_public_url:null};let W=null,P=null;async function $e(t=!1){const n=Date.now();if(t)W=null,P=null;else{if(W&&W.expiresAt>n)return W.models;if(P)return P}const s=Tt().then(r=>(W={expiresAt:Date.now()+Ft,models:r},r));P=s;try{return await s}finally{P===s&&(P=null)}}function Ue(t){return t.length>0?t:[O]}const Gt=`
.watch-studio {
  opacity: 0;
  filter: blur(24px);
  transition:
